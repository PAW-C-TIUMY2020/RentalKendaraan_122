...
namespace RentalKendaraan_122.Controllers
{
    public class PeminjamenController : Controller
    {
        ...
        {
            var rental_KendaraanContext = _context.Peminjaman.Include(p => p.IdCustemerNavigation).Include(p => p.IdJaminanNavigation).Include(p => p.IdKendaraanNavigation);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var peminjaman = await _context.Peminjaman
                .Include(p => p.IdCustemerNavigation)
        ...
        {
            ViewData["IdCustemer"] = new SelectList(_context.Custemer, "IdCustemer", "IdCustemer");
        ...
        public async Task<IActionResult> Create([Bind("IdPeminjaman,TglPeminjaman,IdKendaraan,IdCustemer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
            ...
            ViewData["IdCustemer"] = new SelectList(_context.Custemer, "IdCustemer", "IdCustemer", peminjaman.IdCustemer);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPeminjaman,TglPeminjaman,IdKendaraan,IdCustemer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
