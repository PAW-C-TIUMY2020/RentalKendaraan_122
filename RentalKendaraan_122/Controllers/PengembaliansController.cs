...
namespace RentalKendaraan_122.Controllers
{
    public class PengembaliansController : Controller
    {
        ...
        {
            var rental_KendaraanContext = _context.Pengembalian.Include(p => p.IdKondisiKendaraanNavigation).Include(p => p.IdPeminjamanNavigation);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var pengembalian = await _context.Pengembalian
                .Include(p => p.IdKondisiKendaraanNavigation)
        ...
        {
            ViewData["IdKondisiKendaraan"] = new SelectList(_context.KondisiKendaraan, "IdKondisi", "IdKondisi");
        ...
        public async Task<IActionResult> Create([Bind("IdPengembalian,TglPengembalian,IdPeminjaman,IdKondisiKendaraan,Denda")] Pengembalian pengembalian)
        {
            ...
            ViewData["IdKondisiKendaraan"] = new SelectList(_context.KondisiKendaraan, "IdKondisi", "IdKondisi", pengembalian.IdKondisiKendaraan);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPengembalian,TglPengembalian,IdPeminjaman,IdKondisiKendaraan,Denda")] Pengembalian pengembalian)
        {
